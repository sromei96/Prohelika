...
public class Request extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Request us for a trip");
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);

        mName=findViewById(R.id.name1);
        mPhone=findViewById(R.id.phone1);
        mEventId=findViewById(R.id.place);
        mTransactionId=findViewById(R.id.purpose);
    ...
    private void addArrayList(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            mdatabase.child(id).child("Location").setValue(eventID);
            mdatabase.child(id).child("Purpose").setValue(transaction);
